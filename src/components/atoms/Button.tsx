...
const Button = ({
  ...
  <button
    onClick={onClick}
    className={clsx('rounded-md text-lg transition-all delay-100 hover:scale-105 ease-in-out duration-300', {
      'bg-blue-500 text-white hover:bg-blue-600': variant === 'primary' && !outline,
      'border border-blue-500 text-blue-500 hover:bg-blue-600 hover:text-white': variant === 'primary' && outline,
