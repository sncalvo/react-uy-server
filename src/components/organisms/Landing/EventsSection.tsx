  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap items-center gap-y-1 text-sm leading-6 text-gray-300">
        <time dateTime={dayjs(event.date).format('YYYY-MM-DD')} className="mr-8">
        ...
        <div className="-ml-4 flex items-center gap-x-4">
          ...
          <div className="flex space-x-[-0.5rem]">
            {event.presenters?.map((presenter) => (
              <Image src={presenter.image} alt="" className="h-6 w-6 flex-none rounded-full bg-white/10 shadow-inner ring-1 ring-black/5" key={presenter.id} width={24} height={24} />
            ))}
          </div>
        </div>
      </div>
    ...
    <div className="py-24 sm:py-32" id="events">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Eventos Anteriores</h2>
