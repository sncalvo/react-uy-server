...
const PresenterSection = () => {
  const { formRef, error, success, loading, handleSubmit, onClear } = useForm(createPresenterSchema, createPresenter);

  return (
    <div className="isolate px-6 py-24 sm:py-32 lg:px-8 relative" id="become-speaker">
      <div
      ...
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">¿Quieres ser un speaker?</h2>
        <p className="mt-2 text-lg leading-8 text-gray-600">
          Comparte tus conocimientos con la comunidad React Uruguay, envíanos tu propuesta de charla
        </p>
      </div>
      <div className="mx-auto max-w-2xl mt-8">
        <Alert
          ...
          onDismiss={() => onClear()}
          title={error ? 'Error al crear solicitud' : 'Solicitud creada con éxito'}
          description={
            error ?
              'Por favor, revise los datos e intente de nuevo' : 'Estaremos en contacto apenas podamos para charlar sobre su presentación. Muchas gracias!'
          }
        />
      </div>
      <form ref={formRef}
