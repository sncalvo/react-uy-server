    ...
    <div className="mx-auto grid max-w-7xl gap-x-8 gap-y-20 px-6 lg:px-8 xl:grid-cols-3">
      <div className="max-w-2xl">
        <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
          Conoce Nuestros Organizadores
        </h2>
        <p className="mt-6 text-lg leading-8 text-gray-600">
          Las meetups de React Uruguay son organizadas por las siguientes
          personas y empresas.
        </p>
      </div>
          ...
          <li key={organizer.name}>
            <Link href={organizer.link}>
              <div className="flex items-center gap-x-6">
                <Image
                  className="h-16 w-16 rounded-full shadow-inner ring-1 ring-black/5"
                  src={organizer.image}
                  alt={organizer.alt}
                  width={64}
                  height={64}
                ...
                <div>
                  ...
                  {organizer.position && (
                    <p className="text-sm font-semibold leading-6 text-react-600">
                      {organizer.position}
                    </p>
                  )}
                </div>
