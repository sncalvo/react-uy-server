...
export default async function createPresenter(
  presenter: z.infer<typeof createPresenterSchema>,
) {
  const { email, firstName, lastName, presentationDescription, companyName } =
    presenter;
